...
export default class extends Command {
	...
	async run(interaction: ChatInputCommandInteraction): Promise<void> {
		await interaction.reply({
			...
			'Use the `/calendar` command to view upcoming office hour events.' +
			' You\'ll **receive a DM** with office hour events over the next 10 days that allows for filtering and downloading events to add to your personal calendar.\n\n' +
